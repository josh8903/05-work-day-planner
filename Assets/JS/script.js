...
for (var i = 9; i <= 17; i++) {
    $(".container").append('<div class="time-block"><div class="row"><div class="hour">' + time[i - 9] + '</div><div id="' + i + '" class="description"><textarea id="save' + i + 't" rows="4" cols ="117"></textarea></div><div class="saveBtn"><i id="save' + i + '" class="fa fa-floppy-o"></i></div></div></div>');
